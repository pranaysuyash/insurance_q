...
class InsuranceLiteracyScreen extends StatefulWidget {
  ...
  @override
  State<InsuranceLiteracyScreen> createState() =>
      _InsuranceLiteracyScreenState();
}
...
class _InsuranceLiteracyScreenState extends State<InsuranceLiteracyScreen> {
  ...
  static const _terms = [
    ...
    _Term(
      term: 'Waiting Period',
      definition:
          'The time after buying a policy when certain conditions are not yet covered.',
      icon: Icons.hourglass_top,
    ),
    _Term(
      term: 'Exclusion',
      definition:
          'Conditions, treatments, or situations that your policy does NOT cover.',
      icon: Icons.block,
    ),
    _Term(
      term: 'Cashless Claim',
      definition:
          "Your insurer pays the hospital directly — you don't pay upfront (for network hospitals).",
      icon: Icons.credit_card,
    ),
    _Term(
      term: 'Reimbursement Claim',
      definition:
          'You pay first, then submit bills to your insurer to get paid back.',
      icon: Icons.replay,
    ),
    _Term(
      term: 'Floater Policy',
      definition:
          'A single policy that covers your entire family under one sum insured.',
      icon: Icons.family_restroom,
    ),
    _Term(
      term: 'No Claim Bonus (NCB)',
      definition:
          'A discount or increased coverage you earn for not making a claim in a year.',
      icon: Icons.star,
    ),
    _Term(
      term: 'Pre-existing Disease',
      definition:
          'Any health condition you had before buying the policy. Usually has a longer waiting period.',
      icon: Icons.medical_services,
    ),
    _Term(
      term: 'Co-payment',
      definition:
          'A fixed percentage of the claim amount that you pay yourself (e.g., 10% of ₹1 lakh = ₹10,000).',
      icon: Icons.percent,
    ),
    _Term(
      term: 'Restoration Benefit',
      definition:
          'If your sum insured is exhausted, this benefit restores it (fully or partially) for the same year.',
      icon: Icons.refresh,
    ),
  ];
  ...
  static const _quizQuestions = [
    _QuizQuestion(
      question:
          'What is the amount you pay out of pocket before insurance kicks in?',
      options: ['Premium', 'Deductible', 'Sum Insured', 'Co-payment'],
      correctIndex: 1,
      explanation:
          'The deductible is your out-of-pocket amount before insurance coverage begins.',
    ),
    _QuizQuestion(
      question: 'A floater policy covers:',
      options: [
        'Only the policyholder',
        'The entire family under one sum',
        'Only hospital expenses',
        'Only motor claims'
      ],
      correctIndex: 1,
      explanation:
          'A floater policy covers your entire family under a single sum insured.',
    ),
    _QuizQuestion(
      ...
      correctIndex: 1,
      explanation:
          'In a cashless claim, your insurer settles the bill directly with the network hospital.',
    ),
    _QuizQuestion(
      question: 'No Claim Bonus (NCB) rewards you for:',
      options: [
        'Filing more claims',
        'Not making a claim in a year',
        'Paying premiums on time',
        'Adding family members'
      ],
      correctIndex: 1,
      explanation:
          'NCB is a reward for not filing claims — you get a discount or increased coverage.',
    ),
    _QuizQuestion(
      question: 'A pre-existing disease is:',
      options: [
        'A new illness',
        'A condition you had before buying the policy',
        'A disease covered from day one',
        'An excluded disease always'
      ],
      correctIndex: 1,
      explanation:
          'Pre-existing conditions existed before the policy and usually have a longer waiting period.',
    ),
    _QuizQuestion(
      question:
          'If your sum insured is ₹5 lakh and you use it all, a restoration benefit:',
      options: [
        'Does nothing',
        'Restores the sum for the same year',
        'Only works next year',
        'Doubles your premium'
      ],
      correctIndex: 1,
      explanation:
          'Restoration benefit replenishes your sum insured if it gets exhausted during the year.',
    ),
  ];
    ...
    return Column(
      children: [
        const CoverWisePageHeader(
          title: 'Understand the words that matter',
          subtitle: 'Plain-language definitions and a short knowledge check.',
        ),
        CoverWiseSurface(
          child: Padding(
        ...
        const CoverWiseSectionLabel('Glossary'),
        // Terms list
        Expanded(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle:
                      Text(t.definition, style: const TextStyle(fontSize: 13)),
                  contentPadding:
        ...
        children: [
          ...
          if (_showingExplanation) ...[
            ...
            Semantics(
              liveRegion: true,
              label:
                  _lastAnswerCorrect ? 'Correct answer' : 'Answer needs review',
              child: Container(
                width: double.infinity,
...
class _Term {
  ...
  final IconData icon;
  const _Term(
      {required this.term, required this.definition, required this.icon});
}
