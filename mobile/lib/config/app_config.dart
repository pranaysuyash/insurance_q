class AppConfig {
  ...
  // App configuration
  static const String appName = 'Insurance Policy App';
  ...
  static const List<String> disposableEmailDomains = [
    ...
    'temp-mail.io', 'mohmal.com', 'emailondeck.com',
    'fakeinbox.com', 'trashmail.com', 'getnada.com',
    'tempinbox.com', 'guerrillamailblock.com', 'spam4.me',
    'mailnesia.com', 'trbvm.com', 'incognitomail.org',
    'anonymbox.com', 'mintemail.com'
  ];
