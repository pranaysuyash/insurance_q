...
class ConsentSyncService {
  ...
  Future<int> _syncAll() async {
    ...
    add(ConsentPurpose.analytics, 'analytics');
    add(ConsentPurpose.documentProcessing, 'document_processing');
    // The local terms checkbox is the product's privacy-policy acceptance;
    // the server uses its canonical purpose vocabulary for the audit record.
    add(ConsentPurpose.termsAccepted, 'privacy_policy');
