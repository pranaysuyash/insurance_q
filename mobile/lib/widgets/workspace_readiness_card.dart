...
import '../providers/workspace_readiness_provider.dart';
import '../theme/coverwise_theme.dart';
import '../theme/coverwise_motion.dart';
import 'shared/coverwise_components.dart';
import '../services/analytics_service.dart';

/// At-a-glance policy workspace readiness card shown on the dashboard.
///
/// Displays a readiness label, summary text, and an expandable breakdown
/// of four evidence-backed readiness factors.
class HealthScoreCard extends StatefulWidget {
  final WorkspaceReadinessScore healthScore;

  const HealthScoreCard({super.key, required this.healthScore});

  // Keep the old field name for serialized compatibility.
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      child: Semantics(
        button: true,
        expanded: _expanded,
        label: 'Policy workspace readiness details',
        hint: _expanded ? 'Collapse score details' : 'Show score details',
        child: InkWell(
          borderRadius: BorderRadius.circular(20),
          onTap: () {
            if (!_expanded) {
              AnalyticsService.track('dashboard_health_score_expanded',
                  {'current_score': widget.healthScore.score});
            }
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    // Readiness indicator: score out of 100
                    if (reduceMotion)
