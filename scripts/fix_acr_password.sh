...
echo "Fetching ACR username and password..."
...
echo "Setting container image and registry URL + username (without password)..."
...
echo "Enabling verbose application logging and detailed error messages..."
