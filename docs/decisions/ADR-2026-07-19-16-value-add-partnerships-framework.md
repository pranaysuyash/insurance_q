...
- **Status:** Proposed. **Requires operator sign-off before any code change.** This is a decisions-first ADR — no commits will be made until the partner-vetting policy and the opt-in mechanism are confirmed.
