...
| Date | Entry | Trigger |
|------|-------|---------|
| 2026-07-29 | **Semantics narrowed per [ADR-2026-07-29-02](./ADR-2026-07-29-02-doctrine-stack-reconciliation.md) §4 and constitution Principle 4.** Coverage Check-in surfaces life changes, stale policy data, and questions to verify. It does **not** produce actuarial or financial adequacy verdicts or suitability scoring (Gate C). Original substrate-extension reasoning preserved; semantics constrained. | Operator direction: layered doctrine stack. |
