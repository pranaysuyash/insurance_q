...
| Date | Entry | Trigger |
|------|-------|---------|
| 2026-07-29 | **Reaffirmed per [ADR-2026-07-29-02](./ADR-2026-07-29-02-doctrine-stack-reconciliation.md).** Data-handling policy unchanged. Aligns with constitution Principle 2 (source_text vs retrieval_text separation) and Principle 6. No semantic change. | Operator direction: layered doctrine stack. |
