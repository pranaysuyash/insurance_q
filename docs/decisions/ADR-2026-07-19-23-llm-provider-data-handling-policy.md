...
| Date | Entry | Trigger |
|------|-------|---------|
| 2026-07-29 | **Reaffirmed per [ADR-2026-07-29-02](./ADR-2026-07-29-02-doctrine-stack-reconciliation.md).** Data-handling policy unchanged and aligned with constitution Principle 6 (consent/privacy enforced). No semantic change. | Operator direction: layered doctrine stack. |
